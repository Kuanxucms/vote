<?php
	...
	if($_POST['Submit']){
		...
		$type = $_POST['votetype'];
		$ismore = $_POST['ismore'];
		$result = $db->query("update votename set question_name='$question_name', votetype='$type' , ismore='$ismore' where cid='$id';");
		if($result){
...
<div class="div_from_aoto" style="width: 800px; margin:30px 40px;">
 ...
 ?>
	...
	<form action="" method="post">
	  ...
	  <label>
	  <input name="ismore" type="radio" value="0" checked />否&nbsp;&nbsp;
	  <input name="ismore" type="radio" value="1" />可补充
	  </label>
	  <label>
