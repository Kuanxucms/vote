...
*/
	...
	$jianjie=$_POST['jianjie'];
		...
		//$result = $db->query("update users set passwd='$passwd' where  tel='$tel';");
$result = $db->query("update users set pic='$pic',username='$username',QQ='$QQ',email='$email',province='$province',city='$city',com='$com',domain='$domain',zhiwu='$zhiwu',jianjie='$jianjie' where  tel='$tel';");
		...
		echo "<meta http-equiv=\"Refresh\" content=\"0;url=card.php\">";		
			...
			$result = $db->query("insert into users (admin,isvote,pic,username,passwd,QQ,tel,email,province,city,com,domain,zhiwu,jianjie) values ('0','0','$pic', '$username','$tel','$QQ','$tel','$email','$province','$city', '$com','$domain','$zhiwu','$jianjie')");

			if($result){
				echo "<script>onload = function(){document.getElementById('errortext').innerHTML='资料添加成功';}</script>";
			}
		echo "<meta http-equiv=\"Refresh\" content=\"0;url=card.php\">";	
		}		
...
<div class="main">
	...
	<div class="content">
		...
		<div style="clear:both;"></div>
		 &nbsp;&nbsp;姓&nbsp;&nbsp;  名&nbsp;&nbsp;:<input type="text"  name="username" value="<?php echo $_SESSION['username']; ?>" >
		<div style="clear:both;"></div>
		联系电话:<input type="text"  name="tel" value="<?php echo $_SESSION['tel']; ?>" placeholder="必填项">
		<div style="clear:both;"></div>
...
//-->
		...
		<div class="votebu">
			<input style="width:10em; height:3em; float:left;" type="text" name="code_num" maxlength="4" />
